...
```env
# Supabase
NEXT_PUBLIC_SUPABASE_URLtextyour_supabase_url
NEXT_PUBLIC_SUPABASE_ANON_KEYtextyour_supabase_anon_key
SUPABASE_SERVICE_ROLE_KEYtextyour_service_role_key

# 智谱AI
ZHIPU_API_KEYtextyour_zhipu_api_key

# 火山引擎
VOLC_API_KEYtextyour_volc_api_key
```
