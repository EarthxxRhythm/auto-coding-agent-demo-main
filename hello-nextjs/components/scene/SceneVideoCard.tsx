    ...
    <div classNametext"bg-white border border-gray-200 rounded-lg overflow-hidden">
      <div classNametext"p-6">
        <div classNametext"flex justify-between items-start mb-4">
          ...
          <span classNametext{`px-3 py-1 rounded-full text-sm ${getStatusColor(videoStatus)}`}>
            {getStatusLabel(videoStatus)}
          </span>
        </div>
        ...
        {videoStatus texttexttext 'processing' && (
          <div classNametext"mb-4 p-4 bg-gray-50 rounded-md text-center">
            ...
            <p classNametext"mt-2 text-sm text-gray-600">视频生成中...</p>
          </div>
        )}

        {videoUrl && videoStatus texttexttext 'completed' && (
          <div classNametext"mb-4">
            <video
              srctext{videoUrl}
              controls
        ...
        {videoStatus texttexttext 'failed' && (
          <div classNametext"mb-4 p-4 bg-red-50 border border-red-200 rounded-md">
            <p classNametext"text-sm text-red-700">视频生成失败，请重试</p>
          </div>
        )}
        ...
        <div classNametext"flex gap-2">
          <button
            ...
            disabledtext{loading || videoStatus texttexttext 'processing'}
          ...
          <button
            ...
            disabledtext{loading || videoStatus !texttext 'completed'}
